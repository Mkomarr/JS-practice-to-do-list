...
const searchTask = (e) => {
    ...
    searchList = toDoList.filter(li => li.textContent.toLowerCase().includes(searchText));
    //kasowanie ul i pokazywanie tylko pasujących w nowej tablicy - dodawanie do ul
        ul.textContent = ''; 
